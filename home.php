  ...
  <body>
    ...
    <nav class="navbar fixed-top navbar-expand-lg navbar-light bg-secondary text-white">
      <div class="container-fluid">
        ...
        <a class="navbar-brand" href="home.php">Universitas Andalas</a>
    ...
    <div class="jumbotron text-center bg-info text-white">
      <img src="img/logo unand.png" weight="80" height="100">
      <h1 class="display-4">SISTEM MANAJEMEN GEDUNG KULIAH BERSAMA UNIVERSITAS ANDALAS (SITEGUB UNAND)!</h1>
      <p class="lead">Sistem Menejemen Gedung, Universitas Andalas</p>     
    </div>
      <!-- Akhir Jumbotron -->
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="class col-sm-8 text-justify">
            <p>Universitas Andalas memiliki program studi dan gedung perkuliahan yang banyak, terletak pada area yang luas dan jarak antar masing-masing gedung yang jauh. 
sitegub unand merupakan suatu sistem yang digunakan untuk melakukan peminjaman ruangan secara online. Peminjam dapat mengisi form sesuai prosedur yang telah tersedia tanpa harus mengunjungi ruangan tersebut. Dengan adanya sitegub unand ini akan lebih memudahkan mahasiswa dan dosen dalam melakukan pekerjaan mereka.
</p>
            <p> </p>
            <br></br>
            <br></br>
